...
globals [
  ...
  beta-chromosome-II
  ; INITIAL VALUES
  alpha-conception-chance
  beta-conception-chance
  female-conception-chance
  alpha-mortality-chance
  beta-mortality-chance
  female-mortality-chance
  alpha-body-size
  beta-body-size
  female-body-size
  ; LISTS
...
to setup-parameters
  ifelse selection-part = "none" [ part2-load-chromosomes ] [ part1-load-chromosomes ]
...
to setup-primates
  ask groups [
    ...
    ; MALE 1
    hatch-primates ceiling ( females-per-group / 2 ) [
      initialize-primate
      set sex "male"
      set shape "triangle"
      ...
      set conception-chance alpha-conception-chance
      set mortality-chance alpha-mortality-chance
      set size alpha-body-size
    ...
    hatch-primates ceiling ( females-per-group / 2 ) [
      ...
      set identity-chromosome-II cII
      set current-group myself
      set conception-chance beta-conception-chance
      set mortality-chance beta-mortality-chance
      set size beta-body-size
      initialize-setup-primates ]
    ; FEMALES
    hatch-primates females-per-group [
      ...
      set sex "female"
      set shape "circle"
      set behavior-chromosome-I one-of (list alpha-chromosome-I beta-chromosome-I)
      set behavior-chromosome-II one-of (list alpha-chromosome-II beta-chromosome-II)
      set identity-chromosome-I cI
      set identity-chromosome-II cII
      set current-group myself
      set conception-chance female-conception-chance
      set mortality-chance female-mortality-chance
      set size female-body-size
      initialize-setup-primates ]]
end
...
to initialize-primate
  ...
  set infanticide-attempted? false
end
...
to update-status
  ...
  if random-float 1.0 <= mortality-chance or life-history = "dead" [
    if life-history = "infant" and infanticide-attempted? [ set count-infanticides count-infanticides + 1 ]
...
to attack [ target value ]
  if (infanticide-on? and first-string-is-part-of-last? "i" phenotype-of target) or ( not first-string-is-part-of-last? "i" phenotype-of target) [
    ...
    [ ask target [
      if life-history = "infant" [ set infanticide-attempted? true ]
...
to part1-load-chromosomes
  let loaded-chromosome load-chromosome ( get-file-string genotype-file-number )
  set alpha-chromosome-I first loaded-chromosome
  set alpha-chromosome-II last loaded-chromosome
  set beta-chromosome-I first loaded-chromosome
  set beta-chromosome-II last loaded-chromosome
  set alpha-conception-chance item 1 loaded-chromosome
  set beta-conception-chance item 1 loaded-chromosome
  set female-conception-chance item 1 loaded-chromosome
  set alpha-mortality-chance item 2 loaded-chromosome
  set beta-mortality-chance item 2 loaded-chromosome
  set female-mortality-chance item 2 loaded-chromosome
  set alpha-body-size item 3 loaded-chromosome
  set beta-body-size item 3 loaded-chromosome
  set female-body-size item 3 loaded-chromosome
end

to part2-load-chromosomes
  set alpha-chromosome-I []
  set alpha-chromosome-II []
  set beta-chromosome-I []
  set beta-chromosome-II []

  let loaded-chromosome load-chromosome ( get-file-string female-genotype-file )
  let female-chromosome-I first loaded-chromosome
  let female-chromosome-II last loaded-chromosome
  set female-conception-chance item 1 loaded-chromosome
  set female-mortality-chance item 2 loaded-chromosome
  set female-body-size item 3 loaded-chromosome

  set loaded-chromosome load-chromosome ( get-file-string male1-genotype-file )
  let male1-chromosome-I first loaded-chromosome
  let male1-chromosome-II last loaded-chromosome
  set alpha-conception-chance item 1 loaded-chromosome
  set alpha-mortality-chance item 2 loaded-chromosome
  set alpha-body-size item 3 loaded-chromosome

  set loaded-chromosome load-chromosome ( get-file-string male2-genotype-file )
  let male2-chromosome-I first loaded-chromosome
  let male2-chromosome-II last loaded-chromosome
  set beta-conception-chance item 1 loaded-chromosome
  set beta-mortality-chance item 2 loaded-chromosome
  set beta-body-size item 3 loaded-chromosome

  let index 0
  while [index < length ego-chromosome-list] [
    let ego item index ego-chromosome-list
    ; female alleles
    ifelse first-string-is-part-of-last? "f" ego
    [ set alpha-chromosome-I lput (item index female-chromosome-I) alpha-chromosome-I
      set alpha-chromosome-II lput (item index female-chromosome-II) alpha-chromosome-II
      set beta-chromosome-I lput (item index female-chromosome-I) beta-chromosome-I
      set beta-chromosome-II lput (item index female-chromosome-II) beta-chromosome-II ]
    ; male alleles
    [ ifelse first-string-is-part-of-last? "m" ego
      [ set alpha-chromosome-I lput (item index male1-chromosome-I) alpha-chromosome-I
        set alpha-chromosome-II lput (item index male1-chromosome-II) alpha-chromosome-II
        set beta-chromosome-I lput (item index male2-chromosome-I) beta-chromosome-I
        set beta-chromosome-II lput (item index male2-chromosome-II) beta-chromosome-II ]
      ; other alleles
      [ set alpha-chromosome-I lput one-of (list (item index female-chromosome-I) (item index male1-chromosome-I)) alpha-chromosome-I
        set alpha-chromosome-II lput one-of (list (item index female-chromosome-II) (item index male1-chromosome-II)) alpha-chromosome-II
        set beta-chromosome-I lput one-of (list (item index female-chromosome-I) (item index male2-chromosome-I)) beta-chromosome-I
        set beta-chromosome-II lput one-of (list (item index female-chromosome-II) (item index male2-chromosome-II)) beta-chromosome-II ]]
    set index index + 1
  ]
end
...
to printout-genotype-info
  ...
  file-print (word
    ...
    (count-infanticides / length gestatee-age-list) " "
...
to printout-results
  ...
  file-print (word
    ...
    male1-genotype-file " "
    male2-genotype-file " "
    (count-infanticides / (length gestatee-age-list + 0.00000000001 )) " "
    count primates " "
    ifelse-value ( any? groups with [ group-size > 1] ) [count groups with [ group-size > 1 ]] [0] " "
...
<experiments>
  <experiment name="carrying-capacity" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="female-genotype-file">
      <value value="&quot;F2&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="male2-genotype-file">
      <value value="&quot;M2&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="male1-genotype-file">
      <value value="&quot;M2&quot;"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="top-genotypes-tournament" repetitions="100" runMetricsEveryStep="true">
    <setup>setup-world</setup>
    <go>go</go>
