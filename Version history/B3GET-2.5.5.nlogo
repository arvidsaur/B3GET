...
to go
  ...
  if ceiling ( ticks / 10000 ) = (ticks / 10000) [ export-world (word "4329_20161019_04 G" median [generation] of primates ".csv")]
  tick
end
...
to compete
  ...
  if enemy != nobody [
    ...
    [ ask enemy [ update-energy ( - cost-per-attack ) set heading heading + 180 fd (2 * size) ] ]
...
to mutate-genes
  repeat length chromosomeI * 2 [
    if random-float 1.0 < get-mutation-rate [
